...
import com.jagrosh.jmusicbot.audio.StatusHandler;
...
public class QueueCmd extends MusicCommand 
{
    ...
    public void doCommand(CommandEvent event)
    {
        ...
        StatusHandler sh = (StatusHandler)event.getGuild().getAudioManager().getSendingHandler();
        List<QueuedTrack> list = ah.getQueue().getList();
        if(list.isEmpty())
        {
            Message nowp = sh.getNowPlaying(event.getJDA());
            Message nonowp = sh.getNoMusicPlaying(event.getJDA());
